...
[~, today] = xlsread(filename, 1, 'E7');
%Date conversion
dates.settlement = datenum(settlement, formatData);
dates.today= datenum(today, formatData);
...
dates.swaps.available_maturities_dates = datenum(date_swaps, formatData);
dates.swaps.all_maturities_dates=[]; 
